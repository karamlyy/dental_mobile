...
class CollaborationsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: BlocBuilder<CollaborationsCubit, CollaborationsState>(
        builder: (context, state) {
          if (state is CollaborationsLoading && state is! CollaborationsLoaded) {
          ...
          if (state is CollaborationsLoaded) {
            ...
            return ListView.separated(
              ...
              itemBuilder: (context, index) {
                ...
                final technicianName = collaboration['technicianName'] ?? 'Texnik adı yoxdur';
